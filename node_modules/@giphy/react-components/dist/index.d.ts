...
declare const Gif$1: {
    ({ gif, width, percentWidth, height: forcedHeight, onGifRightClick, className, onGifClick, onGifKeyPress, onGifSeen, onGifVisible, user, backgroundColor, overlay, hideAttribution, noLink, borderRadius, style, tabIndex, }: Props$6): React.JSX.Element;
    className: string;
    imgClassName: string;
