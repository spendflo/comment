...
import { de_DeleteTransitGatewayRouteTableAnnouncementCommand, se_DeleteTransitGatewayRouteTableAnnouncementCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DeleteTransitGatewayRouteTableAnnouncementCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteTransitGatewayRouteTableAnnouncementCommand.getEndpointParameterInstructions()));
