...
import { de_ModifyInstanceMaintenanceOptionsCommand, se_ModifyInstanceMaintenanceOptionsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class ModifyInstanceMaintenanceOptionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ModifyInstanceMaintenanceOptionsCommand.getEndpointParameterInstructions()));
