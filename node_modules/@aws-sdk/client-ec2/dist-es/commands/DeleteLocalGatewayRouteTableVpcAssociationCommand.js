...
import { de_DeleteLocalGatewayRouteTableVpcAssociationCommand, se_DeleteLocalGatewayRouteTableVpcAssociationCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DeleteLocalGatewayRouteTableVpcAssociationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteLocalGatewayRouteTableVpcAssociationCommand.getEndpointParameterInstructions()));
