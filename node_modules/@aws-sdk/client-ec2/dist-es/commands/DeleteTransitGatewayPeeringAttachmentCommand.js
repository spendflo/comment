...
import { de_DeleteTransitGatewayPeeringAttachmentCommand, se_DeleteTransitGatewayPeeringAttachmentCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DeleteTransitGatewayPeeringAttachmentCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteTransitGatewayPeeringAttachmentCommand.getEndpointParameterInstructions()));
