...
import { de_DescribeVpcEndpointServicePermissionsCommand, se_DescribeVpcEndpointServicePermissionsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DescribeVpcEndpointServicePermissionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeVpcEndpointServicePermissionsCommand.getEndpointParameterInstructions()));
