...
import { de_DeleteSpotDatafeedSubscriptionCommand, se_DeleteSpotDatafeedSubscriptionCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DeleteSpotDatafeedSubscriptionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteSpotDatafeedSubscriptionCommand.getEndpointParameterInstructions()));
