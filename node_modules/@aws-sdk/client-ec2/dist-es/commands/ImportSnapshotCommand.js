...
import { ImportSnapshotRequestFilterSensitiveLog, ImportSnapshotResultFilterSensitiveLog, } from "../models/models_6";
...
export class ImportSnapshotCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ImportSnapshotCommand.getEndpointParameterInstructions()));
