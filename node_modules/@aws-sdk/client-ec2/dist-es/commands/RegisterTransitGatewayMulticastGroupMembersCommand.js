...
import { de_RegisterTransitGatewayMulticastGroupMembersCommand, se_RegisterTransitGatewayMulticastGroupMembersCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class RegisterTransitGatewayMulticastGroupMembersCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, RegisterTransitGatewayMulticastGroupMembersCommand.getEndpointParameterInstructions()));
