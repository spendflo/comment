...
import { de_DescribeClientVpnTargetNetworksCommand, se_DescribeClientVpnTargetNetworksCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DescribeClientVpnTargetNetworksCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeClientVpnTargetNetworksCommand.getEndpointParameterInstructions()));
