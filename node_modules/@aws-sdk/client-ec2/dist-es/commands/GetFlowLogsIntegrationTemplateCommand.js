...
import { de_GetFlowLogsIntegrationTemplateCommand, se_GetFlowLogsIntegrationTemplateCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class GetFlowLogsIntegrationTemplateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetFlowLogsIntegrationTemplateCommand.getEndpointParameterInstructions()));
