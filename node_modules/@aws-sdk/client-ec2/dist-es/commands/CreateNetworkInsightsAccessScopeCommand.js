...
import { de_CreateNetworkInsightsAccessScopeCommand, se_CreateNetworkInsightsAccessScopeCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class CreateNetworkInsightsAccessScopeCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateNetworkInsightsAccessScopeCommand.getEndpointParameterInstructions()));
