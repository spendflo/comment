...
import { RequestSpotFleetRequestFilterSensitiveLog, } from "../models/models_6";
...
export class RequestSpotFleetCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, RequestSpotFleetCommand.getEndpointParameterInstructions()));
