...
import { de_UpdateSecurityGroupRuleDescriptionsIngressCommand, se_UpdateSecurityGroupRuleDescriptionsIngressCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class UpdateSecurityGroupRuleDescriptionsIngressCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateSecurityGroupRuleDescriptionsIngressCommand.getEndpointParameterInstructions()));
