...
import { GetLaunchTemplateDataResultFilterSensitiveLog, } from "../models/models_5";
...
export class GetLaunchTemplateDataCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetLaunchTemplateDataCommand.getEndpointParameterInstructions()));
