...
import { de_DescribeVpcEndpointConnectionNotificationsCommand, se_DescribeVpcEndpointConnectionNotificationsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DescribeVpcEndpointConnectionNotificationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeVpcEndpointConnectionNotificationsCommand.getEndpointParameterInstructions()));
