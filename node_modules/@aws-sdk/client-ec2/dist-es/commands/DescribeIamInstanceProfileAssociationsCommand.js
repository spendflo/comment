...
import { de_DescribeIamInstanceProfileAssociationsCommand, se_DescribeIamInstanceProfileAssociationsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DescribeIamInstanceProfileAssociationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeIamInstanceProfileAssociationsCommand.getEndpointParameterInstructions()));
