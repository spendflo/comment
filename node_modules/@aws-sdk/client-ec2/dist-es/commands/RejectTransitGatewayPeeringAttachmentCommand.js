...
import { de_RejectTransitGatewayPeeringAttachmentCommand, se_RejectTransitGatewayPeeringAttachmentCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class RejectTransitGatewayPeeringAttachmentCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, RejectTransitGatewayPeeringAttachmentCommand.getEndpointParameterInstructions()));
