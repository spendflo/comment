...
import { de_DescribeVpcEndpointConnectionsCommand, se_DescribeVpcEndpointConnectionsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DescribeVpcEndpointConnectionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeVpcEndpointConnectionsCommand.getEndpointParameterInstructions()));
