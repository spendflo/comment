...
import { de_DescribeVerifiedAccessInstanceLoggingConfigurationsCommand, se_DescribeVerifiedAccessInstanceLoggingConfigurationsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class DescribeVerifiedAccessInstanceLoggingConfigurationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeVerifiedAccessInstanceLoggingConfigurationsCommand.getEndpointParameterInstructions()));
