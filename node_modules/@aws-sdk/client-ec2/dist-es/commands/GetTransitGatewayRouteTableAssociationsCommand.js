...
import { de_GetTransitGatewayRouteTableAssociationsCommand, se_GetTransitGatewayRouteTableAssociationsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class GetTransitGatewayRouteTableAssociationsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetTransitGatewayRouteTableAssociationsCommand.getEndpointParameterInstructions()));
