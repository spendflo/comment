...
import { de_ModifyInstanceCreditSpecificationCommand, se_ModifyInstanceCreditSpecificationCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class ModifyInstanceCreditSpecificationCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ModifyInstanceCreditSpecificationCommand.getEndpointParameterInstructions()));
