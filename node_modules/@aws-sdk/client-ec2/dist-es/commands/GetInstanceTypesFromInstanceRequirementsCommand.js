...
import { de_GetInstanceTypesFromInstanceRequirementsCommand, se_GetInstanceTypesFromInstanceRequirementsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class GetInstanceTypesFromInstanceRequirementsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetInstanceTypesFromInstanceRequirementsCommand.getEndpointParameterInstructions()));
