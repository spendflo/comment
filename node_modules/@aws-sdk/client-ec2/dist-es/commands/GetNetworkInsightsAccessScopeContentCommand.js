...
import { de_GetNetworkInsightsAccessScopeContentCommand, se_GetNetworkInsightsAccessScopeContentCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class GetNetworkInsightsAccessScopeContentCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetNetworkInsightsAccessScopeContentCommand.getEndpointParameterInstructions()));
