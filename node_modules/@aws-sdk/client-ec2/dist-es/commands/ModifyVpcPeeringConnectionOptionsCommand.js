...
import { de_ModifyVpcPeeringConnectionOptionsCommand, se_ModifyVpcPeeringConnectionOptionsCommand, } from "../protocols/Aws_ec2";
export { $Command };
export class ModifyVpcPeeringConnectionOptionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ModifyVpcPeeringConnectionOptionsCommand.getEndpointParameterInstructions()));
