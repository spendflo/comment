...
exports.ModifyVpnTunnelOptionsCommand = exports.$Command = void 0;
...
class ModifyVpnTunnelOptionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, ModifyVpnTunnelOptionsCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_ec2_1.se_ModifyVpnTunnelOptionsCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.de_ModifyVpnTunnelOptionsCommand)(output, context);
    }
}
