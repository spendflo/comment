...
exports.GetVpnConnectionDeviceSampleConfigurationCommand = exports.$Command = void 0;
...
class GetVpnConnectionDeviceSampleConfigurationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            outputFilterSensitiveLog: models_5_1.GetVpnConnectionDeviceSampleConfigurationResultFilterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return (0, Aws_ec2_1.se_GetVpnConnectionDeviceSampleConfigurationCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.de_GetVpnConnectionDeviceSampleConfigurationCommand)(output, context);
    }
}
