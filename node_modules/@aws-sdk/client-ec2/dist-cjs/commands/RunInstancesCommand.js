...
exports.RunInstancesCommand = exports.$Command = void 0;
...
class RunInstancesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_6_1.RunInstancesRequestFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_ec2_1.se_RunInstancesCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.de_RunInstancesCommand)(output, context);
    }
}
