...
exports.RequestSpotInstancesCommand = exports.$Command = void 0;
...
class RequestSpotInstancesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_6_1.RequestSpotInstancesRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_6_1.RequestSpotInstancesResultFilterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return (0, Aws_ec2_1.se_RequestSpotInstancesCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.de_RequestSpotInstancesCommand)(output, context);
    }
}
