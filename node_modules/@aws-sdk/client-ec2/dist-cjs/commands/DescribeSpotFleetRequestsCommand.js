...
exports.DescribeSpotFleetRequestsCommand = exports.$Command = void 0;
...
class DescribeSpotFleetRequestsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            outputFilterSensitiveLog: models_4_1.DescribeSpotFleetRequestsResponseFilterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return (0, Aws_ec2_1.se_DescribeSpotFleetRequestsCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.de_DescribeSpotFleetRequestsCommand)(output, context);
    }
}
