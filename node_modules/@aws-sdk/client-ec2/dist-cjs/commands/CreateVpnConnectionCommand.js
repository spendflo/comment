...
exports.CreateVpnConnectionCommand = exports.$Command = void 0;
...
class CreateVpnConnectionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, CreateVpnConnectionCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_ec2_1.se_CreateVpnConnectionCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.de_CreateVpnConnectionCommand)(output, context);
    }
}
