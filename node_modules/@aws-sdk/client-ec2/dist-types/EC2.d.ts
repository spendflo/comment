...
export interface EC2 {
     ...
     */
    assignPrivateNatGatewayAddress(args: AssignPrivateNatGatewayAddressCommandInput, options?: __HttpHandlerOptions): Promise<AssignPrivateNatGatewayAddressCommandOutput>;
    assignPrivateNatGatewayAddress(args: AssignPrivateNatGatewayAddressCommandInput, cb: (err: any, data?: AssignPrivateNatGatewayAddressCommandOutput) => void): void;
    assignPrivateNatGatewayAddress(args: AssignPrivateNatGatewayAddressCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssignPrivateNatGatewayAddressCommandOutput) => void): void;
    /**
    ...
    associateIpamResourceDiscovery(args: AssociateIpamResourceDiscoveryCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateIpamResourceDiscoveryCommandOutput) => void): void;
    /**
     * @see {@link AssociateNatGatewayAddressCommand}
     */
    associateNatGatewayAddress(args: AssociateNatGatewayAddressCommandInput, options?: __HttpHandlerOptions): Promise<AssociateNatGatewayAddressCommandOutput>;
    associateNatGatewayAddress(args: AssociateNatGatewayAddressCommandInput, cb: (err: any, data?: AssociateNatGatewayAddressCommandOutput) => void): void;
    associateNatGatewayAddress(args: AssociateNatGatewayAddressCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateNatGatewayAddressCommandOutput) => void): void;
    /**
    ...
    cancelImageLaunchPermission(args: CancelImageLaunchPermissionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CancelImageLaunchPermissionCommandOutput) => void): void;
    /**
     ...
     */
    createCoipCidr(args: CreateCoipCidrCommandInput, options?: __HttpHandlerOptions): Promise<CreateCoipCidrCommandOutput>;
    createCoipCidr(args: CreateCoipCidrCommandInput, cb: (err: any, data?: CreateCoipCidrCommandOutput) => void): void;
    createCoipCidr(args: CreateCoipCidrCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateCoipCidrCommandOutput) => void): void;
    /**
     * @see {@link CreateCoipPoolCommand}
     */
    createCoipPool(args: CreateCoipPoolCommandInput, options?: __HttpHandlerOptions): Promise<CreateCoipPoolCommandOutput>;
    createCoipPool(args: CreateCoipPoolCommandInput, cb: (err: any, data?: CreateCoipPoolCommandOutput) => void): void;
    createCoipPool(args: CreateCoipPoolCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateCoipPoolCommandOutput) => void): void;
    /**
     ...
     */
    createLocalGatewayRouteTable(args: CreateLocalGatewayRouteTableCommandInput, options?: __HttpHandlerOptions): Promise<CreateLocalGatewayRouteTableCommandOutput>;
    createLocalGatewayRouteTable(args: CreateLocalGatewayRouteTableCommandInput, cb: (err: any, data?: CreateLocalGatewayRouteTableCommandOutput) => void): void;
    createLocalGatewayRouteTable(args: CreateLocalGatewayRouteTableCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateLocalGatewayRouteTableCommandOutput) => void): void;
    /**
     * @see {@link CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommand}
     */
    createLocalGatewayRouteTableVirtualInterfaceGroupAssociation(args: CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandInput, options?: __HttpHandlerOptions): Promise<CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandOutput>;
    createLocalGatewayRouteTableVirtualInterfaceGroupAssociation(args: CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandInput, cb: (err: any, data?: CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandOutput) => void): void;
    createLocalGatewayRouteTableVirtualInterfaceGroupAssociation(args: CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandOutput) => void): void;
    /**
     ...
     */
    deleteCoipCidr(args: DeleteCoipCidrCommandInput, options?: __HttpHandlerOptions): Promise<DeleteCoipCidrCommandOutput>;
    deleteCoipCidr(args: DeleteCoipCidrCommandInput, cb: (err: any, data?: DeleteCoipCidrCommandOutput) => void): void;
    deleteCoipCidr(args: DeleteCoipCidrCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteCoipCidrCommandOutput) => void): void;
    /**
     * @see {@link DeleteCoipPoolCommand}
     */
    deleteCoipPool(args: DeleteCoipPoolCommandInput, options?: __HttpHandlerOptions): Promise<DeleteCoipPoolCommandOutput>;
    deleteCoipPool(args: DeleteCoipPoolCommandInput, cb: (err: any, data?: DeleteCoipPoolCommandOutput) => void): void;
    deleteCoipPool(args: DeleteCoipPoolCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteCoipPoolCommandOutput) => void): void;
    /**
     ...
     */
    deleteLocalGatewayRouteTable(args: DeleteLocalGatewayRouteTableCommandInput, options?: __HttpHandlerOptions): Promise<DeleteLocalGatewayRouteTableCommandOutput>;
    deleteLocalGatewayRouteTable(args: DeleteLocalGatewayRouteTableCommandInput, cb: (err: any, data?: DeleteLocalGatewayRouteTableCommandOutput) => void): void;
    deleteLocalGatewayRouteTable(args: DeleteLocalGatewayRouteTableCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteLocalGatewayRouteTableCommandOutput) => void): void;
    /**
     * @see {@link DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommand}
     */
    deleteLocalGatewayRouteTableVirtualInterfaceGroupAssociation(args: DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandInput, options?: __HttpHandlerOptions): Promise<DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandOutput>;
    deleteLocalGatewayRouteTableVirtualInterfaceGroupAssociation(args: DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandInput, cb: (err: any, data?: DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandOutput) => void): void;
    deleteLocalGatewayRouteTableVirtualInterfaceGroupAssociation(args: DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationCommandOutput) => void): void;
    /**
    ...
    disassociateIpamResourceDiscovery(args: DisassociateIpamResourceDiscoveryCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateIpamResourceDiscoveryCommandOutput) => void): void;
    /**
     * @see {@link DisassociateNatGatewayAddressCommand}
     */
    disassociateNatGatewayAddress(args: DisassociateNatGatewayAddressCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateNatGatewayAddressCommandOutput>;
    disassociateNatGatewayAddress(args: DisassociateNatGatewayAddressCommandInput, cb: (err: any, data?: DisassociateNatGatewayAddressCommandOutput) => void): void;
    disassociateNatGatewayAddress(args: DisassociateNatGatewayAddressCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateNatGatewayAddressCommandOutput) => void): void;
    /**
     ...
     */
    getIpamDiscoveredAccounts(args: GetIpamDiscoveredAccountsCommandInput, options?: __HttpHandlerOptions): Promise<GetIpamDiscoveredAccountsCommandOutput>;
    getIpamDiscoveredAccounts(args: GetIpamDiscoveredAccountsCommandInput, cb: (err: any, data?: GetIpamDiscoveredAccountsCommandOutput) => void): void;
    getIpamDiscoveredAccounts(args: GetIpamDiscoveredAccountsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIpamDiscoveredAccountsCommandOutput) => void): void;
    /**
     ...
     */
    modifyLocalGatewayRoute(args: ModifyLocalGatewayRouteCommandInput, options?: __HttpHandlerOptions): Promise<ModifyLocalGatewayRouteCommandOutput>;
    modifyLocalGatewayRoute(args: ModifyLocalGatewayRouteCommandInput, cb: (err: any, data?: ModifyLocalGatewayRouteCommandOutput) => void): void;
