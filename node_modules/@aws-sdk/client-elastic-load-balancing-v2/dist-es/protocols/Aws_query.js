...
const de_AvailabilityZone = (output, context) => {
    ...
    if (output.LoadBalancerAddresses === "") {
        ...
        contents.LoadBalancerAddresses = de_LoadBalancerAddresses(__getArrayIfSingleItem(output["LoadBalancerAddresses"]["member"]), context);
    }
    return contents;
};
...
const de_TargetGroup = (output, context) => {
    ...
    if (output.LoadBalancerArns === "") {
        ...
        contents.LoadBalancerArns = de_LoadBalancerArns(__getArrayIfSingleItem(output["LoadBalancerArns"]["member"]), context);
    }
