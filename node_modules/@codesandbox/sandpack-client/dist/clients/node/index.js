...
var client_utils = require('../../client.utils-6009d5ac.js');
require('outvariant');
require('dequal');
...
function loadPreviewIframe(iframe, url) {
    return types.__awaiter(this, void 0, void 0, function () {
        ...
        return types.__generator(this, function (_a) {
            ...
            types.nullthrows(contentWindow, "Failed to await preview iframe: no content window found");
            TIME_OUT = 90000;
            MAX_MANY_TIRES = 20;
            tries = 0;
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var triesToSetUrl = function () {
                        ...
                        if (tries >= MAX_MANY_TIRES) {
                            reject(types.createError("Could not able to connect to preview."));
                            return;
                        }
...
var SandpackNode = /** @class */ (function (_super) {
    types.__extends(SandpackNode, _super);
    function SandpackNode(selector, sandboxInfo, options) {
        if (options === void 0) { options = {}; }
        var _this = _super.call(this, selector, sandboxInfo, types.__assign(types.__assign({}, options), { bundlerURL: options.bundlerURL })) || this;
        _this._modulesCache = new Map();
        _this.messageChannelId = client_utils.generateRandomId();
        _this._initPromise = null;
        _this.emitter = new client_utils.EventEmitter();
        // Assign iframes
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        this.dispatch({
                            ...
                            title: client_utils.getMessageFromError(err_1)
                        });
    ...
    SandpackNode.prototype.createShellProcessFromTask = function (files) {
        return types.__awaiter(this, void 0, void 0, function () {
            ...
            var _a;
            var _this = this;
            return types.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        packageJsonContent = client_utils.readBuffer(files["/package.json"]);
                        this.emulatorCommand = client_utils.findStartScriptPackageJson(packageJsonContent);
                        ...
                        return [4 /*yield*/, this.emulatorShellProcess.on("exit", function (exitCode) {
                                _this.dispatch({
                                    ...
                                    action: "notification",
                                    notificationType: "error",
                                    title: types.createError("Error: process.exit(" + exitCode + ") called.")
                                });
                            })];
                    case 1:
                        // Shell listeners
                        ...
                        return [4 /*yield*/, this.emulatorShellProcess.on("progress", function (data) {
                                ...
                                if (data.state === "command_running" ||
                                    ...
                                    _this.dispatch({
                                        type: "shell/progress",
                                        data: types.__assign(types.__assign({}, data), { command: [
    ...
    SandpackNode.prototype.manageIframes = function (selector) {
        ...
        types.nullthrows(this.iframe.parentNode, "The given iframe does not have a parent.");
        /**
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.emulator.fs.watch(["*"], [
                                ...
                                ".config",
                                ".vuepress",
                            ], function (message) { return types.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return types.__generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 4:
                                            ...
                                            this._modulesCache.set(event.path, client_utils.writeBuffer(content));
                                            return [3 /*break*/, 9];
                                        case 5:
                                            this.dispatch({
                                                type: "fs/remove",
                                        ...
                                        case 7:
                                            ...
                                            this._modulesCache.set(event.newPath, client_utils.writeBuffer(newContent));
                                            return [3 /*break*/, 9];
                                        ...
                                        case 10:
                                            ...
                                            this.dispatch({
                                                ...
                                                action: "notification",
                                                notificationType: "error",
                                                title: client_utils.getMessageFromError(err_2)
                                            });
                                            return [3 /*break*/, 11];
    ...
    SandpackNode.prototype.updateSandbox = function (setup) {
        var _this = this;
        var _a;
        var modules = client_utils.fromBundlerFilesToFS(setup.files);
        /**
         * Update file changes
         */
        if (((_a = this.emulatorShellProcess) === null || _a === void 0 ? void 0 : _a.state) === "running") {
            Object.entries(modules).forEach(function (_a) {
                ...
                if (!_this._modulesCache.get(key) ||
                    client_utils.readBuffer(value) !== client_utils.readBuffer(_this._modulesCache.get(key))) {
        ...
        Object.entries(modules).forEach(function (_a) {
            var key = _a[0], value = _a[1];
            _this._modulesCache.set(key, client_utils.writeBuffer(value));
        });
    };
    SandpackNode.prototype.dispatch = function (message) {
        ...
        return types.__awaiter(this, void 0, void 0, function () {
            var _c;
            return types.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = message.type;
                        switch (_c) {
