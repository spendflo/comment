...
import type { BaseSandpackMessage, BundlerState, ClientStatus, Modules, NpmRegistry, ReactDevToolsMode, SandboxTestMessage, SandpackErrorMessage, SandpackLogLevel, SandpackMessageConsoleMethods } from "../..";
export declare type SandpackRuntimeMessage = BaseSandpackMessage & ({
    type: "initialized";
} | {
    type: "start";
    firstLoad?: boolean;
