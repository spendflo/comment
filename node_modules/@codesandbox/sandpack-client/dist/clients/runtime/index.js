...
var types = require('../../types-289d954c.js');
...
var Protocol = /** @class */ (function () {
    function Protocol(type, handleMessage, protocol) {
        ...
        this._disposeMessageListener = this.protocol.channelListen(function (msg) { return types.__awaiter(_this, void 0, void 0, function () {
...
var IFrameProtocol = /** @class */ (function () {
    ...
    IFrameProtocol.prototype.dispatch = function (message) {
        ...
        this.frameWindow.postMessage(types.__assign({ $id: this.channelId, codesandbox: true }, message), this.origin);
    };
...
modules) {
    ...
    var totalDependencies = types.__spreadArray(types.__spreadArray([], Object.keys(dependencies), true), Object.keys(devDependencies), true);
...
var _a;
var BUNDLER_URL = "https://" + ((_a = "2.6.9") === null || _a === void 0 ? void 0 : _a.replace(/\./g, "-")) + "-sandpack.codesandbox.io/";
var SandpackRuntime = /** @class */ (function (_super) {
    types.__extends(SandpackRuntime, _super);
    function SandpackRuntime(selector, sandboxSetup, options) {
        ...
        if (typeof selector === "string") {
            ...
            types.nullthrows(element, "The element '" + selector + "' was not found");
        ...
        _this.unsubscribeGlobalListener = _this.iframeProtocol.globalListen(function (mes) {
            ...
            if (_this.options.fileResolver) {
                _this.fileResolverProtocol = new Protocol("fs", function (data) { return types.__awaiter(_this, void 0, void 0, function () {
                    return types.__generator(this, function (_a) {
            ...
            switch (mes.type) {
                ...
                case "action": {
                    if (mes.action === "show-error") {
                        _this.errors = types.__spreadArray(types.__spreadArray([], _this.errors, true), [types.extractErrorDetails(mes)], false);
                    }
                    break;
                }
                case "done": {
    ...
    SandpackRuntime.prototype.updateSandbox = function (sandboxSetup, isInitializationCompile) {
        ...
        this.sandboxSetup = types.__assign(types.__assign({}, this.sandboxSetup), sandboxSetup);
        var files = this.getFiles();
        var modules = Object.keys(files).reduce(function (prev, next) {
            var _a;
            return (types.__assign(types.__assign({}, prev), (_a = {}, _a[next] = {
                code: files[next].code,
                path: next
            }, _a)));
        }, {});
        var packageJSON = JSON.parse(types.createPackageJSON(this.sandboxSetup.dependencies, this.sandboxSetup.devDependencies, this.sandboxSetup.entry));
        try {
            packageJSON = JSON.parse(files["/package.json"].code);
        }
        catch (e) {
            console.error(types.createError("could not parse package.json file: " + e.message));
        }
        ...
        this.dispatch({
            ...
            logLevel: (_d = this.options.logLevel) !== null && _d !== void 0 ? _d : types.SandpackLogLevel.Info,
    ...
    SandpackRuntime.prototype.getCodeSandboxURL = function () {
        ...
        var paramFiles = Object.keys(files).reduce(function (prev, next) {
            var _a;
            return (types.__assign(types.__assign({}, prev), (_a = {}, _a[next.replace("/", "")] = {
                content: files[next].code,
                isBinary: false
            }, _a)));
        }, {});
    ...
    SandpackRuntime.prototype.getFiles = function () {
        ...
        if (sandboxSetup.files["/package.json"] === undefined) {
            return types.addPackageJSONIfNeeded(sandboxSetup.files, sandboxSetup.dependencies, sandboxSetup.devDependencies, sandboxSetup.entry);
        }
    ...
    SandpackRuntime.prototype.initializeElement = function () {
        ...
        types.nullthrows(this.element.parentNode, "The given iframe does not have a parent.");
