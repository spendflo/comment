...
var findStartScriptPackageJson = function (packageJson) {
    ...
    try {
        ...
        throw types.createError("Could not parse package.json file: " + e.message);
    }
    ...
    throw types.createError("Failed to start. Please provide a `start` or `dev` script on the package.json");
};
var getMessageFromError = function (error) {
    ...
    return types.createError("The server could not be reached. Make sure that the node script is running and that a port has been started.");
};
