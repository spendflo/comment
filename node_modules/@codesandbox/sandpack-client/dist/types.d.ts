...
export declare type SandpackMessage = SandpackRuntimeMessage | SandpackNodeMessage;
...
export declare type ClientStatus = "initializing" | "installing-dependencies" | "transpiling" | "evaluating" | "running-tests" | "idle" | "done";
export declare type SandpackMessageConsoleMethods = "log" | "debug" | "info" | "warn" | "error" | "table" | "clear" | "time" | "timeEnd" | "count" | "assert";
...
declare type TestStatus = "running" | "pass" | "fail";
...
export declare type SandboxTestMessage = RunAllTests | RunTests | ClearJestErrors | ({
    type: "test";
...
export declare type Template = "angular-cli" | "create-react-app" | "create-react-app-typescript" | "svelte" | "parcel" | "vue-cli" | "static" | "solid" | "nextjs" | "node";
export {};
