...
prom.collectDefaultMetrics({
  register,
  prefix: `${"scripts_find_token_signer"}_`
});
...
var defaultMeta = {
  process: "scripts_find_token_signer",
    ...
    if (sentryLogging && !process.env.IS_TEST) {
      ...
      if (sentryLevel) {
        const sentryEventID = Sentry.captureMessage(message, {
          ...
          tags: { loggingProcessName: "scripts_find_token_signer" },
...
async function main() {
  ...
  for (const app of apps) {
    try {
      verify2(argv.token, app.sharedSecret, {
...
//# sourceMappingURL=find-token-signer.js.map
