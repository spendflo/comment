...
var require_cjs = __commonJS({
  "opensource/sdk-js/packages/server/dist/cjs/index.js"(exports) {
    ...
    function getApplicationManagementAuthToken2(customer_id, customer_secret, options = {}) {
    ...
    exports.getApplicationManagementAuthToken = getApplicationManagementAuthToken2;
...
async function main() {
  ...
  const customerAuthToken = (0, import_server.getApplicationManagementAuthToken)(
    customer.id,
