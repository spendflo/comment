...
var require_cjs = __commonJS({
  "opensource/sdk-js/packages/server/dist/cjs/index.js"(exports) {
    ...
    exports.getClientAuthToken = getClientAuthToken2;
...
// scripts/generate-client-auth-token.ts
...
prom.collectDefaultMetrics({
  register,
  prefix: `${"scripts_generate_client_auth_token"}_`
});
...
var defaultMeta = {
  process: "scripts_generate_client_auth_token",
    ...
    if (sentryLogging && !process.env.IS_TEST) {
      ...
      if (sentryLevel) {
        const sentryEventID = Sentry.captureMessage(message, {
          ...
          tags: { loggingProcessName: "scripts_generate_client_auth_token" },
...
async function main() {
  ...
  const clientAuthToken = (0, import_server.getClientAuthToken)(
    argv.app,
...
//# sourceMappingURL=generate-client-auth-token.js.map
