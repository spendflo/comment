...
var require_cjs = __commonJS({
  "opensource/sdk-js/packages/server/dist/cjs/index.js"(exports) {
    ...
    var jwt__namespace = /* @__PURE__ */ _interopNamespaceDefault(jwt2);
    ...
    function getServerAuthToken2(project_id, project_secret, options = {}) {
    ...
    async function fetchCordRESTApi(endpoint, { method = "GET", project_id, project_secret, api_url = "https://api-comment-dev.spendflo.com/", body }) {
      ...
      const serverAuthToken = getServerAuthToken2(project_id, project_secret);
    ...
    function validateWebhookSignature(body, cordTimestamp, cordSignature, projectSecret, options = {}) {
      ...
      const hmac = crypto5.createHmac("sha256", projectSecret);
    ...
    exports.getServerAuthToken = getServerAuthToken2;
...
// scripts/generate-application-auth-token.ts
var import_server = __toESM(require_cjs(), 1);
...
var import_types = __toESM(require_cjs2(), 1);
var import_types2 = __toESM(require_cjs2(), 1);
...
var import_types3 = __toESM(require_cjs2(), 1);
...
prom.collectDefaultMetrics({
  register,
  prefix: `${"scripts_generate_application_auth_token"}_`
});
...
var defaultMeta = {
  process: "scripts_generate_application_auth_token",
    ...
    if (sentryLogging && !process.env.IS_TEST) {
      ...
      if (sentryLevel) {
        const sentryEventID = Sentry.captureMessage(message, {
          ...
          tags: { loggingProcessName: "scripts_generate_application_auth_token" },
...
async function main() {
  ...
  const applicationAuthToken = (0, import_server.getServerAuthToken)(argv.app, argv.secret);
...
//# sourceMappingURL=generate-application-auth-token.js.map
